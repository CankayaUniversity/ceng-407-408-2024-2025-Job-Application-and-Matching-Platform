        ...
        return (
            <div
                style={{
                    ...
                    width: 'calc(50% - 16px)',
                    marginBottom: '16px',
                    height: isAccordionOpen ? '700px' : '480px',
                    overflowY: 'auto',
                }}
            ...
            >
                    <div className="w-full px-5 py-10">
                        <div
                            className="max-w-[1000px] mx-auto bg-gray-100 rounded-xl shadow-md">
                            <div
                                        ...
                                        <div>
                                            <div
                                                ...
                                                <div className="space-y-4 text-md">
                                                    ...
                                                    {/*        onClick={() => handleOffer(candidate?.applicationId)}*/}
                                                    ...
                                                    {/*    <button*/}
                                                    {/*        style={{backgroundColor: '#0C21C1', borderColor: '#0C21C2'}}*/}
                                                    {/*        onClick={() => handleDecline(candidate?.applicationId)}*/}
                                                    {/*        className="px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700"*/}
                                                    {/*    >*/}
                                                    {/*        Decline*/}
                                                    {/*    </button>*/}
                ...
                {isAccordionOpen && (
                    ...
                    <div className="min-h-screen bg-gray-100 p-8">
                        <div className="w-full px-5 py-10">
                            <div
                                className="max-w-[2000px] mx-auto bg-gray-100 rounded-xl p-10 space-y-10 shadow-md">
